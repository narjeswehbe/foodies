        ...
        <div class="grid gap-2 lg:grid-cols-3">
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                <div class="flex justify-start mt-4">
                    <a href="#" class="text-xl font-medium text-green-500">{{$f1->first_name}} {{$f1->last_name}}</a>
                </div>
                <div>
                    <p class="mt-2 text-gray-600">{{$f1->feedback}}</p>
                </div>

            </div>
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                <div class="flex justify-start mt-4">
                    <a href="#" class="text-xl font-medium text-green-500">{{$f2->first_name}} {{$f2->last_name}}</a>
                </div>
                <div>
                    <p class="mt-2 text-gray-600">{{$f2->feedback}}</p>
                </div>

            </div>
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                <div class="flex justify-start mt-4">
                    <a href="#" class="text-xl font-medium text-green-500">{{$f3->first_name}} {{$f3->last_name}}</a>
                </div>
                <div>
                    <p class="mt-2 text-gray-600">{{$f3->feedback}}</p>
                </div>
